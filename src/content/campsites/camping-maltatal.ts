...
export const campsite: CampsiteConfig = {
  ...
  camping: {
    ...
    features: [
      ...
      { title: "Zwei moderne Sanitärgebäude", text: "Moderne Sanitäranlagen mit Duschen, WCs, Waschmaschinen, Trockner, Infrarotkabine und barrierefreien Kabinen.", image: { src: `${IMG}/camping_sanitaer.webp`, alt: "Modernes, helles Sanitärgebäude mit roten Fliesen und Holzdecke" } },
      { title: “Restaurant & Pizzeria”, text: "Traditionelle Hausmannskost und Pizza aus dem Holzofen – ACSI-ausgezeichnet als bestes Campingrestaurant Österreichs.", image: { src: `${IMG}/camping_restaurant.webp`, alt: “Kärntner Spezialitäten auf dem Tisch im Freien am Campingplatz” } },
    ],
  },
  ...
  mobilheime: {
    ...
    items: [
      { name: "Mobile Home", kind: "Häuschen im Grünen · bis 5 Personen", text: "Sechs Häuschen mit je 32 m², überdachter Veranda, Küche, zwei Schlafzimmern und Duschbad – Bettwäsche bitte selbst mitbringen.", image: { src: `${IMG}/mobilehome_aussen.webp`, alt: "Mobile Homes mit überdachter Veranda und Bergblick" }, features: ["bis 5 Personen", "32 m²", "überdachte Veranda"] },
      { name: "Juniorsuite im Hotel", kind: "Familiensuite · mit Frühstück", text: "Acht Juniorsuiten mit Balkon, bis zu zwei Schlafzimmern, WLAN, Duschbad und Safe – inkl. Frühstück und Freibad-Nutzung.", image: { src: `${IMG}/juniorsuite_zimmer.webp`, alt: "Geräumige Juniorsuite mit Doppelbett, Sitzecke und Balkonfenster" }, features: ["8 Suiten mit Balkon", "Frühstück inklusive", "direkt am Campingplatz"] },
    ],
  },
  ...
  aktivitaeten: {
    ...
    items: [
      ...
      { title: "Künstlerstädtchen Gmünd", text: "Rund 6 km entfernt: Gmünd lädt mit mittelalterlichem Stadtkern, Porsche-Museum und vielen Galerien zum Bummeln ein.", image: { src: `${IMG}/aktiv_gmuend.webp`, alt: "Blick über die Künstlerstadt Gmünd mit Pfarrkirche, Burgruine und den Bergen Kärntens" } },
      { title: "Kölnbreinsperre & Hochalmstraße", text: "Über die Hochalmstraße zur Kölnbreinsperre – mit 200 m Österreichs höchste Talsperre, mit Mauerführung und Airwalk-Glasboden.", image: { src: `${IMG}/aktiv_koelnbreinsperre.webp`, alt: "Wanderin mit Blick auf die Kölnbreinsperre und die Hohen Tauern" } },
